...
$(document).ready(function costCenterDropdown() {
    ...
    if (window.location.href.indexOf("CheckoutPaymentSubmission.aspx") > -1) {
        ...
        newDiv1.innerHTML = ('<br><label style="padding-right:3px;" id="newLbl">Select Your Cost Center:</label><select id="mycc1" onchange="f1();"><option value="0"></option><option value="DEB SMALL BUSINESS - 4700054241">DEB SMALL BUSINESS - 4700054241</option><option value="Other">Other</option></select>');
...
function END() {
    ...
    if (window.location.href.indexOf("CheckoutPaymentSubmission.aspx") > -1) {
        ...
        else if (result1.value == "DEB SMALL BUSINESS - 4700054241") {
